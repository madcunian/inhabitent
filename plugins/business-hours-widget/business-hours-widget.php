 ...
 * @author    Stan Maksarov <maksarov.sl@gmail.com>
 * @license   GPL-2.0+
 * @link      http://inhabitent.com
 * @copyright 2017 Inhabitent Camping Supply Co.
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        https://github.com/madcunian/inhabitent
 * Description:       A handy business hours widget for Inhabitent Camping Supply Co.
 * Version:           1.0.0
 * Author:            Stan Maksarov
 * Author URI:        @TODO
 * License:           GPL-2.0+
...
class Business_Hours_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$monday_friday = empty( $instance['monday_friday'] ) ? '' : apply_filters( 'widget_monday-friday', $instance['monday_friday'] );
